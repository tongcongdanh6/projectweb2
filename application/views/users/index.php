            ...
            <div class="card">
                <div class="card-body">
                    ...
                    : activate to sort column ascending" style="width: 58.8px;">Email
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dtMaterialDesignExample" rowspan="1" colspan="1" aria-label="Start date
                    : activate to sort column ascending" style="width: 58.8px;">Thao tác
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row">
                                                ...
                                                <td><?= $s['email'] ?></td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="<?= base_url() ?>users/update/<?= $s['id'] ?>">Update</a>
                                                    <a class="btn btn-danger btn-sm" href="<?= base_url() ?>users/delete_user/<?= $s['id'] ?>">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
